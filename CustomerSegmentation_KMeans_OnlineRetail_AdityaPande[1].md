...
plt.title('Customer Segments based on Purchase Frequency and Spend')
plt.show()
...
plt.xlabel('Frequency')
plt.ylabel('Monetary Value')
plt.title('Customer Segmentation into Two Groups')
plt.show()
```
...
plt.title('Customer Segmentation into Two Groups (Log Scale)')
plt.show()
```
